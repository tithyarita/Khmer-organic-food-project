  ...
  <footer class="footer">
    ...
    <div class="footer-right">
      ...
      <div class="social-icons">
        ...
        <a href="mailto:support@khmerorganic.com" aria-label="Message"><i class="fas fa-envelope"></i></a>
      </div>
    </div>
  </footer>
</template>
...
.footer-right p {
  ...
  padding-right: 1rem;           /* spacing between text and icons */
}
.footer-right {
